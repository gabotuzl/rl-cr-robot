...
class EnvConfig:
    ...
    num_timesteps_per_step: int = 800   # simulation substeps per RL step (ms of learn step/ dt) in this cas 24ms of RL step and dt=3e-5
    episode_time: float = 1.0 #CHANGED HERE
